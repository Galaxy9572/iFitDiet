...
public class DeviceScanActivity extends Activity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv_btDevices = (ListView) findViewById(R.id.list);
    ...
    protected void onResume() {
        ...
        lv_btDevices.setAdapter(mLeDeviceListAdapter);
        scanLeDevice(true);
    }
    ...
    private OnServiceDiscoverListener mOnServiceDiscover = new OnServiceDiscoverListener(){
		...
		public void onServiceDiscover(BluetoothGatt gatt) {
            ...
            Toast.makeText(getApplicationContext(),"发现蓝牙设备！",Toast.LENGTH_SHORT);
        }
